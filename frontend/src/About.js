...
function About() {
    ...
    let NatalieText = "Natalie is a senior undergraduate in Computer Science. " +
                    "She works in the UW MALLET Lab on a project involving editing and authoring sections of a textbook on a popular machine earning package in R. " +
                    "She also works in Computational Chemistry Lab creating a user interface for a project on electrical thermal transport. " +
                    "She is passionate about Equality in Computing (EIC) and founded a club by the same name. " +
                    "She has organized four popular bookclubs on equality issues in tech for EIC over the course of her time at UW. " +
